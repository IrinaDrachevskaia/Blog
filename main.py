...
##CONNECT TO DB
#file blog.db was deleted by owner (safity reasons)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            new_comment = Comment(text=form.comment.data, author_id=current_user, post_id=requested_post)
            ...
            return redirect(url_for('login'))
    return render_template("post.html", post=requested_post, current_user=current_user, form=form, comments=all_comments)
